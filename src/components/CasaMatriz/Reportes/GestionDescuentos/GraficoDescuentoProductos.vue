...
<div>
  ...
  <div id="container-graph">
    <div class="titulo">
      <H1>Grafico Descuentos Activos, año {{annio}}</H1>
    </div>
    <Bar v-if="loaded" :chart-data="chartData" :colors="colors"/>
  </div>
...
export default {
  ...
  methods:{
            ...
            .then(r => {
              ...
              r.data.forEach(e => {
                ...
                if (year == this.annio && month == '01' && e.activo){
                  ...
                  this.loadedData[10]++
                }else if (year == this.annio && e.activo){
                  this.loadedData[11]++
                }
              })}).catch(e =>{console.log(e)
      });
    ...
    exportar(){
      ...
      exp.export_pdf().then((pdf) => pdf.save("GraficoDescuentoProductos.pdf"))
    }
  }
}
</script>
